...
NotifyLib.prompt('ZukiWare - Special', 'Loading..', 5)
wait(2)
NotifyLib.prompt('ZukiWare', 'Loaded. Enjoy!', 5)
NotifyLib.prompt('ZukiWare', 'Notify Credits To Zuki Thank You All', 5)
--// minecrafto
local Window = Library.CreateLib("ZukiWare - Special")
...
Section:NewButton("Aimlock", "Q  To lock on people", function()
    NotifyLib.prompt('ZukiWare', '( Press ( P ) To enable aimlock ) Aimlock Loaded Keybind is { Q } ( made by zuki licensed aimlock love u no homo )', 5)
wait(1)
...
Section:NewButton("Silent Aim", "Silent Aim!", function()
     NotifyLib.prompt('ZukiWare', 'Silent Aim Enabled! Credits To Zuki For Modulev2 ( with license )', 5)
-- // Dependencies
...
Section:NewButton("Silent Aimlock", "Enable", function()
    NotifyLib.prompt('ZukiWare', 'Credits TO Zuki For The Lock ( Hes Main Lock But Thats Paid No One Can Deobfuscate Luraph Stay Safe Zuki )' )
...
Section:NewToggle("Chat Mode", "love you all ~ zuki 5928", function(txt)
...
Section:NewButton("Enable ESP!", "", function()
     NotifyLib.prompt('ZukiWare', 'ESP Enabled!', 5)
